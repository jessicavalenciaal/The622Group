...
```{r}
cor(sentiments$WordCount,sentiments$Vader)
```
...
cor(all_subset_msu_data$Vader,all_subset_msu_data$comments)
...
cor(all_subset_msu_data$VaderIntesity,all_subset_msu_data$comments)
